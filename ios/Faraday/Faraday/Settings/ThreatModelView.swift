    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 22) {
                ...
                block(
                    title: "誠實的限制",
                    body: "還原助記詞只恢復金鑰與信箱，不會帶回聊天紀錄。若本機仍留有對方的邀請公鑰，下一則送出的訊息會重新做 X3DH，不必再貼邀請。無法解密的舊封裝會被 ack 後丟棄。尚無後量子（PQXDH）。若 Faraday 關閉，封裝密文會在中繼站記憶體等待 48 小時後丟棄。邀請連結是能力憑證：拿到的人就能傳訊給你。"
                )
            }
            .padding(24)
        }
